    ...
    <>
      <div className="border border-complementary-purple w-full h-full lg:h-[421px] max-w-full md:max-w-[255px] rounded-lg">
        <div className="rounded-t-lg relative">
          ...
          <img className="rounded-t-lg h-[164px] w-full md:w-[255px] object-cover" src="https://images.pexels.com/photos/3861969/pexels-photo-3861969.jpeg?cs=srgb&dl=pexels-thisisengineering-3861969.jpg&fm=jpg" alt="" />
        ...
        <div className="h60 pt-[12px] pb-[20px] px-[22px]">
          <h5 className="text-secundare-orange font-black text-[12px] w-full lg:w-[208px] h-[15px] leading-[15px] mb-[5px] uppercase">Demonstrações</h5>

          <p className="text-principal-black text-[18px] w-full lg:w-[211px] h-full lg:h-[66px] leading-[22px] font-bold">Lorem Ipsum is simply dummy text of the printing and typesetting</p>
        </div>
